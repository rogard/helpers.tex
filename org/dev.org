...
#+begin_src latex  
  ...
  \keys_set:nn{__erw_socket}{ global / cs-new }
#+end_src
...
#+begin_src latex  
  ...
  \keys_set:nn{__erw_socket}{ global / cs-new-plug }
#+end_src
...
#+begin_src latex  
  ...
  \keys_set:nn{__erw_socket}{ global / cs-assign-plug }
#+end_src
...
#+begin_src latex
  \keys_define:nn{ __erw_socket }
  {
    socket / new.code:n
    {
      ...
      \prop_clear_new:N
      \l__erw_socket_new_prop

      \prop_set_from_keyval:Nn
      \__erw_socket_new_prop{ #1 }
      ...
      {%
        ...
        \l__erw_arity_int
        {
          \exp_last_unbraced:Ne
          \__erw_socket_new:nn
          { { \l__erw_name_str }{ \l__erw_arity_int } }
          \seq_new:c{ g__erw_socket_ \l__erw_name_str _plugs_seq }
        }
        { \msg_warning:nnn{ __erw_socket }{ missing }{ arity } }

        \prop_get:NnNTF
        \__erw_socket_new_prop{ plugs }
        \l__erw_plugs_tl
        {
          \seq_if_exist:c{ g__erw_socket_ \l__erw_name_str _plugs_seq }
          {
            \keyval_parse:nnn
            {
              \msg_warning:nnn
            ...
            }
            {
              \__erw_inline:nn{ nn }
              {
                ...
                { #1 }{ ##1 }{ ##2 }
                \seq_gput_right:cn{
                  g__erw_socket_ \l__erw_name_str _plugs_seq
                }{ ##1 }
              }
            }
            { #2 }
        ...
        { \msg_warning:nnn{ __erw_socket }{ generic }{ plugs } }
      }
