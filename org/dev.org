...
#+header: :noweb-ref tex-boilerplate
#+begin_src latex
  \cs_new_protected:Nn \erw_parbox_top:NNN
  {
    \vbox_set_top:Nn #1
    { 
      \erw_content_width_set:N #2
%      \raggedleft
      \erw_strut: \tl_trim_spaces:N #3
    }
  }  
#+end_src
...
#+begin_src latex
  \DeclareObjectType{erw-unary}
#+end_src

#+begin_src latex
  \DeclareTemplateInterface{erw-unary}{erw-marginnote}{1}
  {
    width : length = { 1.1in },
...
#+begin_src latex
  % Source - https://tex.stackexchange.com/a/762059
  % Posted by novvy, modified by community. See post 'Timeline' for change history
  % Retrieved 2026-04-21, License - CC BY-SA 4.0
  \DeclareTemplateCode{erw-unary}{erw-marginnote}{1}
  {
  ...
  {%
    ...
    \noindent % start new paragraph without indent
    \tl_set:Nn\l_tmpa_tl{ #1 }
    \vbox_set_top:Nn \l_tmpa_box
    { 
      \erw_content_width_set:N \l__erw_marginnote_width_dim
      % \raggedleft
      \erw_strut: \tl_trim_spaces:N \l_tmpa_tl
    }
    \erw_box_smash:N \l_tmpa_box
