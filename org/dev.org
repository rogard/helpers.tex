...
#+begin_src latex
  ...
  % Solution: \ExplSyntaxOff\ExplSyntaxOn after \file_input:n
#+end_src

*** writing in non-nested directory

See [[id:e9680a4a-1f36-40b5-8d74-d846ce80b618][this]].

#+begin_src latex
  % ---
  % Warning: pdflatex: Not writing to  <path> (openout_any=p; no extended check)
  % Solution: https://tex.stackexchange.com/a/756108/112708
  % Other: 
#+end_src

*** ~\usepackage{../tex/module}~
...
#+begin_src latex
  ...
  % source_file='../tex/example-boilerplate.tex'
...
#+header: :noweb yes
#+begin_src latex
  \ProvidesPackage{erw-biblatex}{2025/12/21}{1.1}
