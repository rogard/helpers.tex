...
#+begin_src latex
  \ProvidesExplPackage{erw-xtempl-label-content}{2026/04/11}{1.0}
...
#+begin_src latex
  ...
  {2}
  {
    ...
    content : tokenlist = {.<},  % \tl_format:Nn\l_tmpb_tl{<content>}
    % </>
...
#+begin_src latex
  ...
  }
  {
    ...
    \str_set:Ne \l_tmpb_str
    { \exp_args:NNV \tl_format:Nn \l_tmpb_tl \l__erw_content_tl } % fix 2: NV variant
    %\str_show:N \l_tmpb_str
    \exp_args:NVV \__erw_combine:nn \l_tmpa_str \l_tmpb_str
    \group_end:
  }
#+end_src
