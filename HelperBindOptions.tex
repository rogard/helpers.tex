...
%\begin{document}
%
%%\HelperBindOptionsSet{\includepdf}[angle=45, scale=0.85]
%%\HelperBindOptionsEval[scale=0.25]{example-image-a}
%
%\HelperBindOptionsSet+Pdf+{\includepdf}[angle=45, scale=0.85]
